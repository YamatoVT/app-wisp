...
ControladorIp.validarExistenciaIpsEndPointNext,
ControladorIp.registrar
)
router.get("/consultar/:id",ControladorIp.consultarEndPoint)

router.get("/consultar-todos",ControladorIp.consultarTodosEndPoint)

router.put("/actualizar-direccion/:id",
ControladorIp.consultarEndPointNext,
ControladorIp.actualizarDireccion
)
